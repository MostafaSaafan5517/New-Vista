let passportsSwiper = new Swiper(".passports-swiper", {
  slidesPerView: 4,
  grabCursor: true,
  loop: true,
  spaceBetween: 20,
...
stopAutoplay(passportsSwiper, ".passports-swiper");
stopSwiping(passportsSwiper, ".passports-swiper");

makeSlidePerView(passportsSwiper);
